...
## Notation of gap function(irrep_Delta.py AlignDeltaToElStructure)
...
## Shiw the gap function symmetry in $\Delta_{\mathbf{n}k}$(irrep_delta.py InterpolateDelta)
